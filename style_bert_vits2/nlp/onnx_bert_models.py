...
def load_model(language: Languages, pretrained_model_name_or_path: str | None = None, onnx_providers: Sequence[str | tuple[str, dict[str, Any]]] = [
    ("CPUExecutionProvider", {"arena_extend_strategy": "kSameAsRequested"})
], cache_dir: str | None = None, revision: str = "main", enable_cpu_mem_arena: (
    bool | None
